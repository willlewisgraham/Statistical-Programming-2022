...
word_2 <- function(w1){
  ...
  sample_1 <- as.numeric(as.character(sample(as.factor(new_ops[,2]), 1, prob = freq))) 
  return(sample_1)
}
...
word_3 <- function(w1, w2){
  ...
  sample_1 <- as.numeric(as.character(sample(as.factor(new_ops[,3]), 1, prob = freq))) 
  return(sample_1)
}
```
